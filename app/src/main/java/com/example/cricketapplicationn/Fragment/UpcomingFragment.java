...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollView=view.findViewById(R.id.scrollView_upcoming);

        recycler_upcoming.setHasFixedSize(true);
        recycler_upcoming.setNestedScrollingEnabled(false);
        recycler_upcoming.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.HORIZONTAL, false));

        manager = new RequestManager(getContext());
        manager.getFixture(listener, "upcoming");
   return view;
    }
